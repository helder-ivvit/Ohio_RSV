...
var _locX_1  = 18;  // ---- 18 original
var _locX_2 = 52;   //----- 52 original
...
var drawingApp = (function () {
	...
	var canvas,
		...
		clearCanvas = function () {
			...
			//context.clearRect(50, 50, canvasWidth, canvasHeight);
		},
		...
		redraw = function () {
			...
			var locX,
				...
				drawCrayon = function (x, y, color, selected) {
					...
					//context.moveTo(x + 71, y + 11);
					//context.lineTo(x + 71, y + 35);
					//context.lineTo(x + 59, y + 35);
					//context.lineTo(x + 59, y + 33);
					//context.lineTo(x + 41, y + 27);
					//context.lineTo(x + 41, y + 19);
					//context.lineTo(x + 59, y + 13);
					//context.lineTo(x + 59, y + 11);
					//context.lineTo(x + 71, y + 11);
			...
			if (curTool === "crayon") {
				...
				context.drawImage(eraserImage, _locX_1, (_locX_1+1) , mediumImageWidth, mediumImageHeight);
			}
			...
			//context.rect(locX, locY, 22, 32);

			context.closePath();
			context.fillStyle = 'red'//'#333333';
			context.fill();
...
mouseY = (e.changedTouches ? e.changedTouches[0].pageY : e.pageY) - this.offsetTop;
		...
		init = function () {
			...
			crayonImage.src = "/Content/canvas/images/crayon-outline.png";

			markerImage.onload = resourceLoaded;
			markerImage.src = "/Content/canvas/images/marker-outline.png";

			eraserImage.onload = resourceLoaded;
			eraserImage.src = "/Content/canvas/images/eraser-outline.png";

			crayonBackgroundImage.onload = resourceLoaded;
			crayonBackgroundImage.src = "/Content/canvas/images/crayon-background.png";

			markerBackgroundImage.onload = resourceLoaded;
			markerBackgroundImage.src = "/Content/canvas/images/marker-background.png";

			eraserBackgroundImage.onload = resourceLoaded;
			eraserBackgroundImage.src = "/Content/canvas/images/eraser-background.png";

			crayonTextureImage.onload = resourceLoaded;
			crayonTextureImage.src = "/Content/canvas/images/crayon-texture.png";

			outlineImage.onload = resourceLoaded;
			//outlineImage.src = "/Content/canvas/images/watermelon-duck-outline.png";
			outlineImage.src = "/Content/canvas/images/006.png";
		};

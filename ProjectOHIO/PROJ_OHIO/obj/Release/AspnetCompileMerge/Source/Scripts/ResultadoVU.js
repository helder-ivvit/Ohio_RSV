...
/*
function mostrarresultvu() {
    $('#modal-sm-result-vu').modal('show');
}
*/
...
function loadDataResultVU() {
    ...
    $.ajax({
        url: "/ResultadoVU/ListarResultado",
        type: "GET",
        data: {
            anio: _anio,
            mes: _mes,
